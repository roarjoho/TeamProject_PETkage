		...
		<div class="container">			
			<div class="row">
				...
				<div class="col-lg-9 order-1 order-lg-2">
					<div class="container">
					<div>
					<h3 style="float: left;">내 후기글 보기</h3>
					<select id="boardSelectOption" onchange="location.href=this.value" style="float: right;">
						...
						<option selected="selected" value="${pageContext.request.contextPath}/mypage/mypageBoard2">후기글</option>
						...
						<option value="${pageContext.request.contextPath}/mypage/mypageBoard4">자랑(사진)</option>
								...
								<div class="cart-table">
			                        <table>
			                            ...
			                            <tbody>
			                            	<c:if test="${myBoardView2 ne null }">
				                            	<c:forEach var="myBoardView2" varStatus="status" items="${myBoardView2}">
				                             		<tr>
				                             			<td>${status.count }</td>
				                             			<td>${myBoardView2.board_title}</td>
				                             			<td>${myBoardView2.user_id}</td>
				                             			<td>${myBoardView2.board_createDate}</td>
				                             			<td>${myBoardView2.board_hit}</td>
				                             		</tr>
				                             	</c:forEach>				                           
			                             	</c:if>
